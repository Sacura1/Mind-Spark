...
const Header = () => {
  ...
  return (
    <header className="bg-black/90 backdrop-blur-sm border-b border-gray-800/50 relative z-50">
      <div className="max-w-full mx-auto px-6">
        ...
        {isMenuOpen && (
          <div className="lg:hidden absolute top-16 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-b border-gray-700/50 z-50">
            <div className="px-6 py-4 space-y-4">
              ...
              <a href="/weekly-leaderboard" className="flex items-center space-x-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200 py-2">
                <BarChart3 className="h-4 w-4" />
                <span>Weekly Leaderboard</span>
              </a>
            </div>
